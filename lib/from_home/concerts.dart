...
import 'package:entry_page/extra_detail/concert_detail.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     body: SingleChildScrollView(
      child: Column(
        children: [
          Text("Concerts now", style: TextStyle(fontFamily: "Merienda", fontSize: 24.0, fontWeight: FontWeight.bold, decoration: TextDecoration.none, color: Colors.black,),),
                    ...
                    child: MaterialButton(
                      onPressed: (){
                        Navigator.push(context,
                          MaterialPageRoute(builder: (context) => ConcertBookingPage()
                          ),
                        );
